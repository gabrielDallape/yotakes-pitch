...
- `julia-casal.jpg` — a foto original do casal, de onde sai o recorte do medalhão; não é usada no deck.
- `casal-circulo.jpg` — a mesma foto recortada no quadrado, no medalhão do segundo CTA.
